...
这里我用的是 [DOSBox0.74-3-win32](../../../static/assets/files/DOSBox.exe.zip)。

debug.exe 需要另外下载，现在网上乱七八糟的，我就直接上传到这了，[下载debug](../../../static/assets/files/debug.exe.zip)。下载之后将 debug.exe 放在自己喜欢的目录中，例如`D:\Debug`。
...
![dosbox](../../../static/assets/images/2021/0422/WX_20210422232611.png)

最后，写条汇编练练手。

![asm](../../../static/assets/images/2021/0422/WX_20210422233705.png)
...
在官网下载，也可以直接在这里下载[DOSBox-0.74-3-3](../../../static/assets/files/DOSBox.dmg.zip)。

将`debug.exe`放在喜欢的目录，如`/Users/wu/Bin`。

运行比较简单，直接点击打开，使用`mount C /Users/wu/Bin`挂载即可，然后就可以使用 debug，其它操作跟 Win10 一致。

![macos](../../../static/assets/images/2021/0423/WX20210423-092600.png)
