...
![test](../../../static/assets/images/2019/0506/20190506215000.png)

第一行内容是字段名。保存后关闭该文件，并在新的工作簿选中下图红色箭头选项`来自 Microsoft Query`。

![select](../../../static/assets/images/2019/0506/20190506220930.png)

接着在弹出的对话框中选择`Excel Files`，点击确定。

![confirm](../../../static/assets/images/2019/0506/20190506221321.png)

选择刚才的`test.xlsx`文件，点击确定。

![file](../../../static/assets/images/2019/0506/20190506221655.png)

在下图左边框选择`Sheet1$`，点击中间的`>`按钮，点击下一步。以之后的弹窗可一直点击下一步。

![next](../../../static/assets/images/2019/0506/20190506222126.png)

直到出现以下窗口，这里建议选择第二个选项，点击完成。

![complete](../../../static/assets/images/2019/0506/20190506222326.png)

现在会出现刚才的结果。点击箭头方向的`SQL`按钮即可执行其它 SQL 语句。

![sql](../../../static/assets/images/2019/0506/20190506222458.png)
