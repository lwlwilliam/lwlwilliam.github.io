...
![Raspberry](../../../static/assets/images/2020/0226/WX_20200226230509.png)
...
2.  [官网](https://www.raspberrypi.org/downloads/)下载树莓派操作系统，注意下载箭头所指的 Raspbian（NOOBS 的安装方式跟这个不太一样）：
    ...
    ![](../../../static/assets/images/2020/0226/WX_20200226233100.png)
3.  用 [Etcher](https://www.balena.io/etcher/) 将操作系统写入 SD 卡，如图选择系统镜像以及 SD 卡，点击 Flash! 即可：

    ![](../../../static/assets/images/2020/0226/WX_20200226233511.png)
...
2.  打开`控制面板->网络和共享中心->更改适配器设置`，找到笔记本当前连网的适配器，我现在用的是`WLAN`，如下图。
    ...
    ![WLAN](../../../static/assets/images/2020/0226/WX_20200311232531.png)
   
3.  共享给网线接口的网络适配器，我这里是`以太网`。

    ![WLAN](../../../static/assets/images/2020/0226/WX_20200311232934.png)
    
4.  查看`以太网`的网卡接口，点击`状态->详细信息`。

    ![WLAN](../../../static/assets/images/2020/0226/WX_20200311233336.png)
    
    ![WLAN](../../../static/assets/images/2020/0226/WX_20200311233408.png)
    
5.  查看`以太网`连接的主机，这里使用了`arp -a`命令。

    ![WLAN](../../../static/assets/images/2020/0226/WX_20200311233450.png)
